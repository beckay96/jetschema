...
export function TaskFeed({ comments, onNavigateToTarget, onUpdateComment }: TaskFeedProps) {
  ...
  const TaskItem = ({ comment }: { comment: Comment }) => (
    <div className="flex items-start gap-3 p-2 rounded-lg hover:bg-primary bg-background dark:text-white text-black transition-colors group">
  ...
  return (
    <Card className="h-full flex flex-col overflow-y-auto bg-background dark:text-white text-black">
      ...
      <CardContent className="flex-1 overflow-y-auto p-4 space-y-4">
        <div className="space-y-6">
          ...
          {recentComments.length > 0 && (
            <div className="space-y-2 bg-background dark:text-white text-black">
