...
import { TableEditModal } from '@/components/database/DatabaseTablesComponents/EditingTables/TableEditModal';
...
import { SchemaContextMenu, SchemaElementType } from '../Other/SchemaContextMenu';
